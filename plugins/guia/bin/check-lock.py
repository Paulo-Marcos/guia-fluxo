...
def cmd_hook(args: argparse.Namespace) -> int:
    try:
        ...
        # Falha transiente de I/O (arquivo travado por outro processo,
        # path malformado) nao deve bloquear o commit. Degrada liberando.
        sys.stderr.write(
            f"Aviso: nao consegui ler a mensagem de commit ({exc}). Hook liberado.\n"
        )
        return 0
    try:
